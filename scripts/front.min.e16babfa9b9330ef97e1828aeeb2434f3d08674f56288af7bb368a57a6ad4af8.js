...
function sliders(){if($('.owl-carousel').length){$('.homepage').owlCarousel({navigation:true,navigationText:['<i class="fas fa-angle-left"></i>','<i class="fas fa-angle-right"></i>'],slideSpeed:500,paginationSpeed:500,autoPlay:true,stopOnHover:true,singleItem:true,lazyLoad:true,addClassActive:true,afterInit:function(){},afterMove:function(){}})}}